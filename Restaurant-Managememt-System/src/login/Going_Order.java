 ...
 */
public class Going_Order extends javax.swing.JFrame {

    private String name;
    /**
     * Creates new form Going_Order
     */
...
//                        Amount
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name of Customer", "Table No", "Time Remaining", "Total Price"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Going_Order.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Going_Order().setVisible(true);
            }
        });
    }
